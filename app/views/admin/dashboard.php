                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Total Buses</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $data['totalBuses'] ?></div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Total Routes</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo  $data['totalRoutes']?></div>
                        </div>
                        <div class="col-auto">
